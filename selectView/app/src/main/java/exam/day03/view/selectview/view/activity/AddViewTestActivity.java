...
public class AddViewTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Layout에 추가할 view를 생성 - 상위뷰의 크기 정보를 갖고 있는 LayoutParams를 생성
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Button btn2 = new Button(AddViewTestActivity.this); //그냥 this 여기선 익명 이너클래스이기 때문에 X
                                                                            //그래서 outer클래스 지칭해줘야 함
